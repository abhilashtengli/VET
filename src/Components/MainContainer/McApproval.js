      ...
      <div className=" bg-gray-200">
        ...
        <div className=" justify-center flex">
          <div className="bg-white w-auto m-5 md:h-auto   rounded-3xl shadow-lg ">
            <img
              className="w-52 h-auto mt-1 md:w-64 md:m-5  p-10"
              alt="pci_logo"
              src={pci_logo}
            />
            <h2 className="text-center text-2xl -mt-7 font-semibold md:-mt-10 pb-5">
              PCI
            </h2>
          </div>
          <div className="bg-white m-5 rounded-3xl shadow-lg ">
            <img className="md:w-64 md:m-5 md:h-64" alt="" src={bead_logo} />
