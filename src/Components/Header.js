...
const Header = () => {
  ...
  return (
    <>
      <div className=" sticky top-0 flex justify-between bg-green-100 md:z-10 shadow-lg md:sticky md:top-0 w-full bg-opacity-75 backdrop-blur-sm items-center md:py-2">
        <Link to="/">
          <img
